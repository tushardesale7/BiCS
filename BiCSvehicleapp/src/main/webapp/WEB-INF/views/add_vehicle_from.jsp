...
<div class="container mt-3">
	<div class="row">
		<div class="col-md-6 offset-md-3">
			...
			<h1 class="text-center mb-3"> Fill the vehicle Details</h1>
			
			<form action="handle-vehicle" method="post">
				<div class="form-group">
					<label for="name">Vehicle Name</label>
					<input type="text" class="form-control" id="name" aria-describedby="emailHelp"
						name="name" placeholder="Enter the vehicle Name">
				</div>
				<div class="form-group">
					<label for="model_no">Vehicle Model No.</label>
					<input type="text" class="form-control" id="model_no" autocapitalize="characters"
						name="model_no" placeholder="Enter the vehicle Model No">
				</div>
				<div class="form-group">
					...
					<input type="date" class="form-control" id="manufactured_date" min="2000-01-01"
						name="manufactured_date" placeholder="Enter the vehicle Manufactured Date">
				</div>
					<div class="form-group">
				...
				<div class="form-group">
					...
					<input type="number" class="form-control" id="torque" aria-describedby=emailHelp"
						name="torque" placeholder="Enter the vehicle Torque value">
				</div>
					<div class="form-group">
					...
					<input type="number" class="form-control" id="brake_horse_power" aria-describedby="emailHelp"
						name="brake_horse_power" step="any" placeholder="Enter the Vehicle's Brake horse power">
				</div>
				<div class="form-group">
					<label for="max_speed">Vehicle's Maximum Speed(kmph)</label>
					<input type="number" class="form-control" id="max_speed" 
						name="max_speed" placeholder="Enter the vehicle's Maximum Speed(kmph)">
				</div>
				<div class="form-group">
					...
					<input type="number" class="form-control" id="max_acceleration" aria-describedby=emailHelp"
						name="max_acceleration" placeholder="Enter the Vehicle's Maximum Acceleration">
				</div>
				<div class="form-group">
					<label for="run">Vehicle's Running (km)</label>
					<input type="number" class="form-control" id="run" aria-describedby=emailHelp"
						name="run" placeholder="Enter the Vehicle's Running (km)">
				</div>
				<div class="form-group">
